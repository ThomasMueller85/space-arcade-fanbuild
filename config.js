...
export const EXHAUST_MAX   = 220;   // Obergrenze Partikel
export const EXHAUST_RATE  = 160;   // Partikel pro Sekunde (bei vollem Schub)
export const EXHAUST_LIFE  = 0.55;  // Lebensdauer in s
export const EXHAUST_SPREAD= 0.32;  // seitliche Streuung
export const EXHAUST_KICK  = 240;   // Startgeschwindigkeit rückwärts
export const EXHAUST_DRAG  = 0.85;  // Luft-/Weltraum-"Widerstand" pro Sekunde
export const EXHAUST_SIZE  = 0.18;  // Basisgröße relativ zu r
